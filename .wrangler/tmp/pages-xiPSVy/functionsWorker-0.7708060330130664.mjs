...
var onRequestPost = /* @__PURE__ */ __name(async (context2) => {
  ...
  try {
    ...
    const API_KEY = context2.env.GEMINI_API_KEY;
    if (!API_KEY) {
    ...
    const prompt = lang === "ko" ? `\uB0A0\uC528 \uB370\uC774\uD130\uB97C \uC2E4\uC6A9\uC801\uC778 \uC548\uB0B4\uB85C \uBCC0\uD658\uD574\uC918. \uBC18\uB4DC\uC2DC JSON\uB9CC \uBC18\uD658\uD574.

\uB370\uC774\uD130:
- \uC624\uB298 \uCD5C\uACE0\uAE30\uC628: ${p.tMax}\xB0C, \uCD5C\uC800: ${p.tMin}\xB0C
- \uC5B4\uC81C \uCD5C\uACE0\uAE30\uC628: ${p.yMax}\xB0C, \uCD5C\uC800: ${p.yMin}\xB0C
- \uC5B4\uC81C \uB300\uBE44 \uBCC0\uD654: ${direction}${absDelta}\xB0C
- \uCCB4\uAC10\uC628\uB3C4: ${p.feels_like || p.feels || p.tMax}\xB0C
...
JSON \uD615\uC2DD:
{"hero":"...","context":"...","action":"\u{1F9E5} ...","proof":"${p.tMax}\xB0C ${direction}${absDelta}\xB0"}` : `Convert weather data to practical guidance. Return JSON only.

Data:
- Today high: ${p.tMax}\xB0C, low: ${p.tMin}\xB0C
- Yesterday high: ${p.yMax}\xB0C, low: ${p.yMin}\xB0C
- Change: ${direction}${absDelta}\xB0C
- Feels like: ${p.feels_like || p.feels || p.tMax}\xB0C
- Wind: ${p.windSpeed || p.wind || 0}m/s
${absDelta >= 3 ? `- IMPORTANT: ${absDelta}\xB0 difference` : ""}

Rules: hero max 12 words, guidance first, mention delta if 3\xB0+

JSON format:
{"hero":"...","context":"...","action":"\u{1F9E5} ...","proof":"${p.tMax}\xB0C ${direction}${absDelta}\xB0"}`;
    ...
    return new Response(
      JSON.stringify({ success: true, translation, timestamp: (/* @__PURE__ */ new Date()).toISOString() }),
      { headers: corsHeaders }
    );
  } catch (error3) {
    return new Response(
      JSON.stringify({ success: false, error: "Translation failed", message: error3.message }),
...
// ../../.wrangler/tmp/pages-xiPSVy/functionsRoutes-0.9401729476693454.mjs
var routes = [
  {
...
// ../../.wrangler/tmp/bundle-7yfVko/middleware-insertion-facade.js
...
// ../../.wrangler/tmp/bundle-7yfVko/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7708060330130664.mjs.map
